class MovieStorage
{
    ...
    public MovieStorage()
    {
        Movie movie1 = new Movie(1, "Major Leage", 5.99, true, 0, null);
        Movie movie2 = new Movie(2, "Police Academy", 6.99, true, 0, null);
        Movie movie3 = new Movie(3, "Major Payne", 4.99, true, 0, null);
        Movie movie4 = new Movie(idCounter, "Stripes", 7.99, true, 0, null); idCounter++;
