...
class Program
{
    ...
    public static void CharInStrings()
    {
        // public static int checkForALetter(List<string> stringList, string letter)
        // {
        //     //WRITE YOUR CODE HERE
        //     char charToFind = 'a';
        //     int totalOccurrences = stringList.SelectMany(s => s).Count(c => c == charToFind);
        //     System.Console.WriteLine(totalOccurrences);
    ...
    public static void SortStrings()
    {
        ...
        // foreach (string word in alphabetize)
        // {
