...
class Program
{
    ...
    public static void RyanReverseString() //pulls each character starting at the end individually?
    {
    ...
    public static void ReversedString() //goes backwards indexing the string?
    {
